#### Module : model 07 (naive bayes with bag of words, sentiment polarity and emotion)
...
def model_07(data):
    ...
    X = df[['text', 
            ...
            'polarity_compound',
            'emotion_code']]
    vectorizer = CountVectorizer(max_features = 20000, ngram_range =(1,3), analyzer='char')
