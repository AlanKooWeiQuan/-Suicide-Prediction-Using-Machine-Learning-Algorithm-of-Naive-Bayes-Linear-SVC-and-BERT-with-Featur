...
data = data_loading.load_data(r'C:\Users\AlanKoo99\Desktop\test_pos_neg_word.csv')
...
data = suicide_keyword_analysis(data)
# data.to_csv(r'C:\Users\AlanKoo99\Desktop\test_pos_neg_word.csv', index = False)
...
def highlight_keyword (data):
    ...
    fig.text(0.5, 0.5, replaced_text, ha='center', va='center', size=10, color="black", wrap=True)
    # fig.text(0.5, 0.5, "OK", ha='center', va='center', size=10, color="green")
    plt.show()

text1 = "I love and like you baby, but i am very disappointed and angry at you!"
# text1 = "Works like a champ! Easy to install and clone....OS now loads quickly. Everything is just perfect."
highlight_keyword (text1)
