...
data2 = data_loading.load_data(r'C:\Users\AlanKoo99\Desktop\FYP coding\data\testing\2_twitter\twitter_testing_data_emotion.csv')
data3 = model_20_testing(data, data2)
data3 = data3.drop(data3.columns[[0]],axis = 1)
data3.to_csv(r'C:\Users\AlanKoo99\Desktop\FYP coding\data\testing\2_twitter\twitter_testing_data_prediction_result.csv')
